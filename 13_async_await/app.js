...
function calculateSumAsync(a, b) {
    return new Promise(function (resolve) {
        setTimeout(function () {
            var sum = a + b; // Calcul de la somme
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    sum = _a.sent();
                    console.log("La somme est : ".concat(sum)); // Afficher le résultat une fois que la promesse est résolue
                    return [2 /*return*/];
            }
        });
    });
...
function verifyUser(username, password) {
    return new Promise(function (resolve, reject) {
        var correctUsername = "admin"; // Nom d'utilisateur correct
        var correctPassword = "password123"; // Mot de passe correct
...
verifyUser("admin", "password123")
    .then(function (message) { return console.log(message); }) // Si les informations sont correctes
    .catch(function (error) { return console.error(error); }); // Si une erreur se produit
//exercice 3
//exo1
var Calculator = /** @class */ (function () {
    ...
    Calculator.prototype.addNumbersAsync = function (a, b) {
        return new Promise(function (resolve) {
            setTimeout(function () {
                var sum = a + b; // Calcul de la somme
                resolve(sum); // Résolution de la promesse avec la somme
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Calcul en cours..."); // Afficher avant de commencer le calcul
                    return [4 /*yield*/, calculator.addNumbersAsync(a, b)];
                case 1:
                    sum = _a.sent();
                    console.log("La somme est : ".concat(sum)); // Afficher le résultat une fois que la promesse est résolue
                    return [2 /*return*/];
...
var User = /** @class */ (function () {
    ...
    User.prototype.checkCredentials = function (username, password) {
        return new Promise(function (resolve, reject) {
            var correctUsername = "admin"; // Nom d'utilisateur correct
            var correctPassword = "password123"; // Mot de passe correct
            // Vérification des informations
